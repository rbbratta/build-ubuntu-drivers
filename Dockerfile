...
RUN tar --transform=s,^updates,kernel, --owner=root --group=root --numeric-owner -C /lib/modules/3.13.0-93-generic/ -cvzf /root/drivers/drivers-ubuntu-14.04-3.13.0-93-generic-i40e-1.5.19-ixgbe-4.4.6.tar.gz updates
